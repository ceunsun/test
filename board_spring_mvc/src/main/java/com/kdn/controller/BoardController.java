...
public class BoardController {
	...
	public String insertBoard(Board board, HttpServletRequest request){
		...
		return "redirect:listBoard.do"; //forward라서 경로가 계속 살아있고 요청정보가 계속 있음. 그래서 메서드 호출하지 말고 redirect로 해야함
	}
	
	@RequestMapping(value="listBoard.do", method=RequestMethod.GET) //post로 지정하지 않으면 다 get방식임 
	...
	@RequestMapping(value="searchBoard.do", method=RequestMethod.GET) //post로 지정하지 않으면 다 get방식임 
